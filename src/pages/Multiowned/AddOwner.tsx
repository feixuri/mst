...
export function AddOwner() {
  ...
  const onOwnerAddressInput = useCallback((typedValue: string): void => {
  ...
  async function onAdd() {
    ...
    const addOwner = multiowned.addOwner
        ...
        <Wrapper>
          ...
          <AutoColumn gap="20px">
            <AutoRow style={{ alignItems: 'center', justifyContent: 'space-between' }} gap="8px">
              ...
              <TYPE.mediumHeader>AddOwner</TYPE.mediumHeader>
              <div>
            ...
            <AutoColumn gap={'md'}>
              <TextInputPanel
                ...
                onUserInput={onOwnerAddressInput}
              />
            </AutoColumn>
            {!account ? (
