...
export function BitcoinOracleSet() {
  ...
  const onBitcoinOracleInput = useCallback((typedValue: string): void => {
  ...
  async function onAdd() {
    ...
    const mint = issuerManager.setBitcoinOracle
  ...
  const pendingText = `Set BitcoinOracle`
        ...
        <Wrapper>
          ...
          <AutoColumn gap="20px">
            <AutoRow style={{ alignItems: 'center', justifyContent: 'space-between' }} gap="8px">
              <BackArrow to={`/owner`} />
              <TYPE.mediumHeader>Set BitcoinOracle</TYPE.mediumHeader>
              <div>
            ...
            <AutoColumn gap={'md'}>
              <TextInputPanel
                ...
                onUserInput={onBitcoinOracleInput}
              />
            </AutoColumn>
            {!account ? (
